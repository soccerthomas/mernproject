  ...
  return (
    <div className="bg-gray-800">
      ...
      <div className="mx-auto py-12">
        ...
        <div className="text-center">
          <h1 className="pt-8 font-semibold text-white lg:text-2xl sm:text-xl">About Tier List Maker</h1>
          <p className="mt-4 text-md font-medium text-pretty text-gray-400 sm:text-md">Create and share easily accessible tier lists of all of your favorite subjects. You can create tier lists for movies, TV 
shows, videos games, etc</p>
        </div>
      </div>
    </div>
  );
